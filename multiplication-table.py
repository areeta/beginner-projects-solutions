...
# Create a program that prints out a multiplication table for the numbers
    # 1 through 9.
# It should include the numbers 1 through 9 on the top and left axises,
    ...
    # Do not simply write out every line manually
    # (ie print(‘7 14 21 28 35 49 56 63’) ).

# Subgoals:
    # As your products get larger, your columns will start to get crooked
        # from the number of characters on each line.
    # Clean up your table by evenly spacing columns so it is very easy
